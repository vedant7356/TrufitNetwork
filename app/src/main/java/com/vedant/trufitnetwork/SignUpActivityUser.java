                                        ...
                                        databaseReference.child(userID).setValue(hashMap)
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        Toast.makeText(SignUpActivityUser.this, R.string.user_created_successfully, Toast.LENGTH_SHORT).show();
                                                        startActivity(new Intent(SignUpActivityUser.this, UserLogin.class));
                                                    }
                                                });


                                    } else {
                                        Toast.makeText(SignUpActivityUser.this,
